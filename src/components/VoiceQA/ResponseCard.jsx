...
export default function ResponseCard({ item, onSpeak, isSpeaking, onStop }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border-l-4 border-l-primary overflow-hidden">
      {/* Question */}
